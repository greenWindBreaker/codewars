//standup056
//Friday, 02/03/23, usually teaspill but today we have standup on remo.co @ 6pm
...
//below is how you would build a Queue in javascript as well as the answer to tonights code challenge
class Queue{
    constructor(){
        this.list = []
    }
    ...
    dequeue(){
        return this.list.shift()//shift() is O(n)
    }
}